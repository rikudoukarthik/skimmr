...
#'
#' @format A tibble with `r format(nrow(ebird_admin_units), big.mark = ",")` observations
#'   and `r dim(ebird_admin_units)[2]` variables (names and 2-letter ISO codes).
#'
#' @seealso
#' The script to update the data in `skimmr`:
#'   <https://github.com/rikudoukarthik/skimmr/blob/main/data-raw/ebird_admin_units.R>
